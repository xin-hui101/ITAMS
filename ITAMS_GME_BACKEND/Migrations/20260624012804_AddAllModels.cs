...
namespace ITAMS_GME_BACKEND.Migrations
{
    ...
    public partial class AddAllModels : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MaintenanceRecords_Users_CreatedBy",
                        column: x => x.CreatedBy,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AssetFieldValues_CategoryFields_CategoryFieldId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AssetFieldValues_CategoryFieldId",
                table: "AssetFieldValues",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MaintenanceRecords_CreatedBy",
                table: "MaintenanceRecords",
                column: "CreatedBy");
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 18, "Read", null, "Notifications" });
        }
    }
}
